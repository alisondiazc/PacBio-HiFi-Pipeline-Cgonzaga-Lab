# 9. Liftover de ensamble contra CHM13-T2T a coordenadas de GRCh38
...
CrossMap.py vcf chm13v2-hg38.over.chain.gz PYM007_T2T_deepvariant.vcf Homo_sapiens_GRCh38.p14.noMT.name1.fasta PYM007_T2T_deepvariant.lift.vcf
```
